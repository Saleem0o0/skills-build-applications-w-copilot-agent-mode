...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        octo_models.Activity.objects.create(user=captain, type='Bike', duration=60, calories=500)
        octo_models.Activity.objects.create(user=superman, type='Fly', duration=120, calories=1000)
        ...
        # Create Leaderboard
        octo_models.Leaderboard.objects.create(team=marvel, points=800)
        octo_models.Leaderboard.objects.create(team=dc, points=1400)
